...
- **Ground Segmentation**: Achieved ×2.0 performance improvement using Patchwork++ optimization
- **LiDAR SLAM Pipeline**: ×2.0 performance improvement for real-time mapping
...
- **3D CAD Design**: Sensor mounting bracket design using TinkerCAD
...
**Dataset**: Custom Xpanner field data, Roboflow pothole datasets, Boryeong dataset

## Key Results

| Metric | Improvement |
|--------|-------------|
| Ground Segmentation (Xpanner) | ×2.0 |
| LiDAR SLAM (Xpanner) | ×2.0 |
| 3D Map Points | 1.5B → 300M (filtered) |
